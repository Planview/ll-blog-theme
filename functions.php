<?php
/**
 * Afterthought functions and definitions
 *
 ...
 */
function afterthought_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Afterthought, use a find and replace
	 * to change 'afterthought' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'afterthought', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'afterthought' ),
	) );
 ...
 */
function afterthought_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'afterthought' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'afterthought_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'afterthought_scripts' );
